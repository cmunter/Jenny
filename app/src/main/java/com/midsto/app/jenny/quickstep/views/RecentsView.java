...
import com.midsto.app.jenny.BaseActivity;
import com.midsto.app.jenny.DeviceProfile;
import com.midsto.app.jenny.Insettable;
import com.midsto.app.jenny.InvariantDeviceProfile;
import com.midsto.app.jenny.LauncherState;
import com.midsto.app.jenny.PagedView;
...
import com.midsto.app.jenny.anim.SpringObjectAnimator;
...
import com.midsto.app.jenny.util.OverScroller;
import com.midsto.app.jenny.util.PendingAnimation;
import com.midsto.app.jenny.util.Themes;
import com.midsto.app.jenny.util.ViewPool;
import com.midsto.app.jenny.quickstep.RecentsAnimationWrapper;
import com.midsto.app.jenny.quickstep.RecentsModel;
import com.midsto.app.jenny.quickstep.RecentsModel.TaskThumbnailChangeListener;
import com.midsto.app.jenny.quickstep.TaskThumbnailCache;
import com.midsto.app.jenny.quickstep.TaskUtils;
...
import static com.midsto.app.jenny.BaseActivity.STATE_HANDLER_INVISIBILITY_FLAGS;
import static com.midsto.app.jenny.InvariantDeviceProfile.CHANGE_FLAG_ICON_PARAMS;
import static com.midsto.app.jenny.LauncherAnimUtils.SCALE_PROPERTY;
import static com.midsto.app.jenny.LauncherAnimUtils.VIEW_TRANSLATE_X;
import static com.midsto.app.jenny.LauncherAnimUtils.VIEW_TRANSLATE_Y;
import static com.midsto.app.jenny.Utilities.EDGE_NAV_BAR;
import static com.midsto.app.jenny.Utilities.squaredHypot;
import static com.midsto.app.jenny.Utilities.squaredTouchSlop;
import static com.midsto.app.jenny.anim.Interpolators.ACCEL;
...
import static com.midsto.app.jenny.uioverrides.touchcontrollers.TaskViewTouchController.SUCCESS_TRANSITION_PROGRESS;
import static com.midsto.app.jenny.userevent.nano.LauncherLogProto.Action.Touch.TAP;
import static com.midsto.app.jenny.userevent.nano.LauncherLogProto.ControlType.CLEAR_ALL_BUTTON;
...
public abstract class RecentsView<T extends BaseActivity> extends PagedView implements Insettable,
    ...
    public void onSwipeUpAnimationSuccess() {
        if (getRunningTaskView() != null) {
            float startProgress = BaseFlags.ENABLE_QUICKSTEP_LIVE_TILE.get()
    ...
    private void addDismissedTaskAnimations(View taskView, AnimatorSet anim, long duration) {
        ...
        if (BaseFlags.QUICKSTEP_SPRINGS.get() && taskView instanceof TaskView)
    ...
    public PendingAnimation createTaskDismissAnimation(TaskView taskView, boolean animateTaskView,
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child == taskView) {
                ...
                if (scrollDiff != 0) {
                    if (BaseFlags.QUICKSTEP_SPRINGS.get() && child instanceof TaskView) {
