 ...
 */
package com.midsto.app.jenny.views;
...
import com.midsto.app.jenny.InsettableFrameLayout.LayoutParams;
...
import com.midsto.app.jenny.dragndrop.FolderAdaptiveIcon;
import com.midsto.app.jenny.folder.FolderIcon;
import com.midsto.app.jenny.graphics.IconShape;
import com.midsto.app.jenny.graphics.ShiftedBitmapDrawable;
import com.midsto.app.jenny.icons.LauncherIcons;
import com.midsto.app.jenny.popup.SystemShortcut;
...
import static com.midsto.app.jenny.Utilities.getBadge;
import static com.midsto.app.jenny.Utilities.getFullDrawable;
import static com.midsto.app.jenny.Utilities.isRtl;
import static com.midsto.app.jenny.Utilities.mapToRange;
...
import static com.midsto.app.jenny.states.RotationHelper.REQUEST_LOCK;
...
public class FloatingIconView extends View implements
    ...
    private static void getIconResult(Launcher l, View originalView, ItemInfo info, RectF pos,
        ...
        Drawable badge = null;
        boolean supportsAdaptiveIcons = BaseFlags.ADAPTIVE_ICON_WINDOW_ANIM.get()
