...
import com.midsto.app.jenny.LauncherAnimUtils;
...
import com.midsto.app.jenny.util.FlingBlockCheck;
import com.midsto.app.jenny.util.PendingAnimation;
import com.midsto.app.jenny.util.TouchController;

import static com.midsto.app.jenny.LauncherAnimUtils.MIN_PROGRESS_TO_ALL_APPS;
...
import static com.midsto.app.jenny.LauncherStateManager.ATOMIC_OVERVIEW_SCALE_COMPONENT;
import static com.midsto.app.jenny.LauncherStateManager.NON_ATOMIC_COMPONENT;
import static com.midsto.app.jenny.anim.Interpolators.scrollInterpolatorForVelocity;
...
public abstract class AbstractStateChangeTouchController
    ...
    public void onDragEnd(float velocity, boolean fling) {
        ...
        if (fling && targetState == LauncherState.ALL_APPS && !BaseFlags.QUICKSTEP_SPRINGS.get()) {
