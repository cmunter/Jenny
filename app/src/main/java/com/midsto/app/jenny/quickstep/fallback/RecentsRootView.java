 ...
 */
package com.midsto.app.jenny.quickstep.fallback;
...
public class RecentsRootView extends BaseDragLayer<RecentsActivity> {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int width = Math.max(MIN_SIZE, View.MeasureSpec.getSize(widthMeasureSpec));
        int height = Math.max(MIN_SIZE, View.MeasureSpec.getSize(heightMeasureSpec));
