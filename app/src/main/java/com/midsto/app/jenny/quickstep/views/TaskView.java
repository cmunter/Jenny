...
import com.midsto.app.jenny.util.ViewPool.Reusable;
import com.midsto.app.jenny.quickstep.RecentsModel;
import com.midsto.app.jenny.quickstep.TaskIconCache;
import com.midsto.app.jenny.quickstep.TaskOverlayFactory;
import com.midsto.app.jenny.quickstep.TaskSystemShortcut;
import com.midsto.app.jenny.quickstep.TaskThumbnailCache;
import com.midsto.app.jenny.quickstep.TaskUtils;
import com.midsto.app.jenny.quickstep.util.TaskCornerRadius;
import com.midsto.app.jenny.quickstep.views.RecentsView.PageCallbacks;
import com.midsto.app.jenny.quickstep.views.RecentsView.ScrollState;
...
import static com.midsto.app.jenny.QuickstepAppTransitionManagerImpl.RECENTS_LAUNCH_DURATION;
    ...
    public void onTaskListVisibilityChanged(boolean visible) {
        ...
        if (visible) {
            ...
            mIconLoadRequest = iconCache.updateIconInBackground(mTask,
                    (task) -> {
                        setIcon(task.icon);
                        if (BaseFlags.ENABLE_QUICKSTEP_LIVE_TILE.get() && isRunningTask()) {
