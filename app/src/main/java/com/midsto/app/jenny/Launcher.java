...
import com.midsto.app.jenny.DropTarget.DragObject;
import com.midsto.app.jenny.accessibility.LauncherAccessibilityDelegate;
import com.midsto.app.jenny.allapps.AllAppsContainerView;
import com.midsto.app.jenny.allapps.AllAppsStore;
import com.midsto.app.jenny.allapps.AllAppsTransitionController;
import com.midsto.app.jenny.allapps.DiscoveryBounce;
import com.midsto.app.jenny.anim.PropertyListBuilder;
import com.midsto.app.jenny.compat.AppWidgetManagerCompat;
import com.midsto.app.jenny.compat.LauncherAppsCompatVO;
import com.midsto.app.jenny.config.FeatureFlags;
import com.midsto.app.jenny.dot.DotInfo;
import com.midsto.app.jenny.dragndrop.DragController;
import com.midsto.app.jenny.dragndrop.DragLayer;
import com.midsto.app.jenny.dragndrop.DragView;
import com.midsto.app.jenny.folder.Folder;
import com.midsto.app.jenny.folder.FolderIcon;
import com.midsto.app.jenny.folder.FolderIconPreviewVerifier;
import com.midsto.app.jenny.graphics.RotationMode;
import com.midsto.app.jenny.icons.IconCache;
import com.midsto.app.jenny.keyboard.CustomActionsPopup;
import com.midsto.app.jenny.keyboard.ViewGroupFocusHelper;
import com.midsto.app.jenny.logging.FileLog;
import com.midsto.app.jenny.logging.StatsLogUtils;
import com.midsto.app.jenny.logging.UserEventDispatcher;
import com.midsto.app.jenny.logging.UserEventDispatcher.UserEventDelegate;
import com.midsto.app.jenny.model.AppLaunchTracker;
import com.midsto.app.jenny.model.ModelWriter;
import com.midsto.app.jenny.notification.NotificationListener;
import com.midsto.app.jenny.popup.PopupContainerWithArrow;
import com.midsto.app.jenny.popup.PopupDataProvider;
import com.midsto.app.jenny.shortcuts.DeepShortcutManager;
import com.midsto.app.jenny.states.InternalStateHandler;
import com.midsto.app.jenny.states.RotationHelper;
import com.midsto.app.jenny.touch.ItemClickHandler;
import com.midsto.app.jenny.uioverrides.UiFactory;
import com.midsto.app.jenny.userevent.nano.LauncherLogProto;
import com.midsto.app.jenny.userevent.nano.LauncherLogProto.Action;
import com.midsto.app.jenny.userevent.nano.LauncherLogProto.ContainerType;
import com.midsto.app.jenny.userevent.nano.LauncherLogProto.Target;
import com.midsto.app.jenny.util.ActivityResultInfo;
import com.midsto.app.jenny.util.ComponentKey;
import com.midsto.app.jenny.util.IntArray;
import com.midsto.app.jenny.util.ItemInfoMatcher;
import com.midsto.app.jenny.util.MultiValueAlpha;
import com.midsto.app.jenny.util.MultiValueAlpha.AlphaProperty;
import com.midsto.app.jenny.util.PackageManagerHelper;
import com.midsto.app.jenny.util.PackageUserKey;
import com.midsto.app.jenny.util.PendingRequestArgs;
import com.midsto.app.jenny.util.RaceConditionTracker;
import com.midsto.app.jenny.util.SystemUiController;
import com.midsto.app.jenny.util.Themes;
import com.midsto.app.jenny.util.Thunk;
import com.midsto.app.jenny.util.TraceHelper;
import com.midsto.app.jenny.util.UiThreadHelper;
import com.midsto.app.jenny.util.ViewOnDrawExecutor;
import com.midsto.app.jenny.views.ActivityContext;
import com.midsto.app.jenny.views.OptionsPopupView;
import com.midsto.app.jenny.views.ScrimView;
import com.midsto.app.jenny.widget.LauncherAppWidgetHostView;
import com.midsto.app.jenny.widget.PendingAddShortcutInfo;
import com.midsto.app.jenny.widget.PendingAddWidgetInfo;
import com.midsto.app.jenny.widget.PendingAppWidgetHostView;
import com.midsto.app.jenny.widget.WidgetAddFlowHandler;
import com.midsto.app.jenny.widget.WidgetHostViewLoader;
import com.midsto.app.jenny.widget.WidgetListRowEntry;
import com.midsto.app.jenny.widget.WidgetsFullSheet;
import com.midsto.app.jenny.widget.custom.CustomWidgetParser;
...
import static com.midsto.app.jenny.AbstractFloatingView.TYPE_SNACKBAR;
import static com.midsto.app.jenny.LauncherAnimUtils.SPRING_LOADED_EXIT_DELAY;
...
import static com.midsto.app.jenny.LauncherState.OVERVIEW_PEEK;
import static com.midsto.app.jenny.dragndrop.DragLayer.ALPHA_INDEX_LAUNCHER_LOAD;
import static com.midsto.app.jenny.logging.LoggerUtils.newContainerTarget;
import static com.midsto.app.jenny.logging.LoggerUtils.newTarget;
import static com.midsto.app.jenny.states.RotationHelper.REQUEST_NONE;
import static com.midsto.app.jenny.util.RaceConditionTracker.ENTER;
import static com.midsto.app.jenny.util.RaceConditionTracker.EXIT;
